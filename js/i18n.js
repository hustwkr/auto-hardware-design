...
(function(global) {
  ...
  var D = {
    ...
    "safe.iso.label":    { zh: "电网 ↔ PV/DC 侧", en: "Grid ↔ PV/DC Side" },
    "safe.iso.isolated": { zh: "有隔离 (变压器/光耦 — DC侧OVC自动降一档)", en: "Isolated (transformer/opto — DC OVC steps down)" },
    "safe.iso.noniso":   { zh: "无隔离 (DC侧取两者较高值)", en: "Non-isolated (DC takes higher of two)" },
    ...
    "safe.sysVac":       { zh: "AC系统电压 (V)", en: "AC System Voltage (V)" },
    "safe.sysVdc":       { zh: "DC系统电压 (V)", en: "DC System Voltage (V)" },
    ...
    "safe.pcb.no":       { zh: "否(端子)", en: "No (Terminal)" },
    "safe.pcb.yes":      { zh: "是(PCB)", en: "Yes (PCB)" },
    "safe.coat.no":      { zh: "无", en: "None" },
    "safe.coat.t1":      { zh: "Type 1 (降PD)", en: "Type 1 (Reduce PD)" },
    "safe.coat.t2":      { zh: "Type 2/灌封", en: "Type 2/Potting" },
    "safe.gnd.no":       { zh: "否(线间)", en: "No (Line-line)" },
    "safe.gnd.yes":      { zh: "是(对地)", en: "Yes (To Gnd)" },
    ...
    "safe.report.calcProc":{ zh: "各节点计算过程", en: "Per-Node Calculation Details" },
    ...
    "safe.chain.forcedReinf":{ zh: "⚠ 对地节点强制加强", en: "⚠ Forced Reinforced" },
...
/* Capacitor — dynamic UI */
    ...
    "safe.imp.isoDown":  { zh: "(隔离降档)", en: "(Isolated step-down)" },
    "safe.imp.noIso":    { zh: "无隔离取较高值", en: "(Non-isolated, higher value)" },
